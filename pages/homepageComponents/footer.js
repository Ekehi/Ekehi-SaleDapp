...
export default function Footer()
{
    return (
        <>
            <footer id="footer" className=" pt-8 w-[100vw]">
                ...
                <div className="grid justify-items-center justify-center grid-flow-row auto-rows-min fullwidth  gap-30 py-8 px-6">
                    <div className="relative m-auto">
                        ...
                        and the world. For users, the project affords a secure, accessible,
                        and empowering platform for investing and taking part inside the cryptocurrency environment.
                        For investors, EKEHI gives a sustainable and socially accountable investment opportunity
                        with lengthy-time period increase potential. For the world, the project contributes to positive
