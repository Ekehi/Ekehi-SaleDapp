    ...
    const services = [
        {
            ...
            icon: "/icons/ekehi-token.png", // Path relative to the public folder
        },
        {
            title: "EkehiChain",
            discription:
        ...
        },
        {
            ...
            icon: "/icons/ekehi-foundation.png",
        },
        {
            ...
            icon: "/icons/rwa-tokenization.png",
        }
    ];
