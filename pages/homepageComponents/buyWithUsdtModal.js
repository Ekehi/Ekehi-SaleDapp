  ...
  */
  ...
  useEffect(() =>
  {
    ...
    if (usdtValue <= usdtBalanceOfWalletConnected)
    {
      ...
      setConvertToUsdtButtonClass("default-color text-white hover:text-white hover:bg-slate-300 active:bg-red-900 font-bold uppercase text-base px-8 py-3 rounded-[24px] shadow-md hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150");
    ...
    else
    {
      ...
      setUsdtInputBoxError(
        <>
          <div className="flex">
            <p class="mt-2 text-sm tcolor"><span class="font-medium">Oh, sorry!</span> you have insufficient USDT balance.<br />
  ...
  useEffect(() =>
  {
      ...
      setConvertToUsdtInProcessText(
        <>
          <div className="flex items-center justify-center mb-5">
            ...
            <p class="mt-2 text-sm text-green-200"> Please wait, <span class="font-medium">transaction</span> in progress...</p>
          </div>
        </>);
    }
    else if (waitForTransactionIsSuccess)
    {
      ...
      setConvertToUsdtInProcessText(
        <>
          <div className="flex items-center justify-center mb-5">
            <p class="mt-2 text-sm text-green-200"><span class="font-medium">Congratulations!</span> Your purchase was successful. <br />
  ...
  return (
    <>
      <button
        className="default-color text-white hover:text-white hover:bg-slate-300 active:bg-red-900 font-bold uppercase text-base px-8 py-3 rounded-[24px] shadow-md hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
        type="button"
                ...
                <div className="relative p-6 flex-auto">
                  <form className="bg-neutral-800 shadow-md rounded px-8 pt-6 pb-8 w-full">
                    <div className="flex">
                      ...
                      <span className="inline-flex items-center px-5 text-sm w-50 text-gray-900 bg-gray-200 rounded-r-md border border-r-0 border-gray-300">
                       
                        <img 
                 src="/images/EKEHI-mini.png" className="relative inline-flex rounded-full h-9 w-10" alt="Ekehi" />
